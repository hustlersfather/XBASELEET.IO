...
<a class=“dropdown-item waves-effect waves-light” href=“rdp” style=“color: var(—font-color);”><span class=“px-2”><i class=“fas fa-desktop fa-fw”></i> RDPs <span class=“badge badge-primary”><span id="rdps"></span></span></a>
<a class=“dropdown-item waves-effect waves-light” href=“cPanel” style=“color: var(—font-color);”><span class=“px-2”><i class=“fas fa-tools fa-fw”></i> cPanels <span class=“badge badge-primary”><span id="cpanels">  </span></span></a>
...
<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
<a class="dropdown-item" href="mailer" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Mailers <span class="badge badge-primary"><span id="mailers"></span></span></a>
...
<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
<a class="dropdown-item" href="accounts" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-comments-dollar"></i> premium/dating/shop<span class="badge badge-primary"><span id="account"></span></span></a>
<!---
...
--->
 ...
 <li class="nav-item dropdown mr-auto">
<a class="nav-link dropdown-toggle" style="color: var(--font-color);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-mail-bulk"></i>USA Bank(Fullz Info)
</a>
<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
...
<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
<a class="dropdown-item" href="scampages" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-scams-time"></i> Scampages<span class="badge badge-primary"><span id="scampage"></span></span></a>
