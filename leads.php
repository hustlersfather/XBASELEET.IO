...
<div class="col-xs-6 col-sm-4 col-lg-2" style="display:inline-block">
<label for="leads_country" style="margin-bottom: 10px; margin-top: 5px">Country :</label>
...
<div class="col-xs-6 col-sm-4 col-lg-2" style="display:inline-block"> <label for="seller" style="margin-bottom: 10px; margin-top: 5px">Seller :</label>
<select name="seller" id="leads_seller" class="form-control" style="color: var(--font-color); background-color: var(--color-card);">
