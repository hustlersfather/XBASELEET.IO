  ...
  <td>
                        ...
                        <td>
                            <select class='filterselect form-control input-sm' name="tuto_seller">
                                ...
                                <?php
$query = mysqli_query($dbcon, "SELECT DISTINCT(`resseller`) FROM `tutorials` WHERE `sold` = '0' or `sold` = '1' ORDER BY resseller ASC");nwhile($row = mysqli_fetch_assoc($query)){zz
		\\
